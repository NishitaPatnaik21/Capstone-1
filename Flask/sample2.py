...
#tile_dims = tiles.get_tile_dimensions(1, (1,1)) #Provide deep zoom level and address (column, row)
...
#tile_dims = tiles.get_tile_dimensions(16, (22372,6004))
...
#single_tile = tiles.get_tile(1, (1, 1)) #Provide deep zoom level and address (column, row)
